...
public class InterstitialAdController : MonoBehaviour
{
    ...
    /// Shows the ad.
    /// </summary>
    public void ShowAd(Action onClose, Action onNotReady)
    {
...
#if UNITY_EDITOR
    [CustomEditor(typeof(InterstitialAdController))]
    public class InterstitialAdController_Inspector : Editor
    {
        public override void OnInspectorGUI()
        {
            DrawDefaultInspector();

            InterstitialAdController target = (InterstitialAdController)base.target;
