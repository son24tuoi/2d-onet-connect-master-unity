...
public class NativeOverlayAdController : MonoBehaviour
{
    ...
    /// <summary>
    /// Renders the ad placement target.
    /// </summary>
    public void RenderAdPlacmentTarget(RectTransform placementTarget, Canvas canvas)
    {
        if (_nativeOverlayAd != null)
        {
            Debug.Log("Rendering Native Overlay ad.");

            _nativeOverlayAd.RenderTemplate(Style, placementTarget, canvas);
